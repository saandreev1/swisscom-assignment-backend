...
INSERT INTO "new_FeedbackRequest" ("candidateEmail", "createdAt", "formId", "id", "reviewerId", "token") SELECT "candidateEmail", "createdAt", "formId", "id", "reviewerId", "token" FROM "FeedbackRequest";
